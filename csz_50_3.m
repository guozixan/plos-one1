...
K1=40,K2=35,K3=10,K4=5,alpha=0.7,beta=0.6,C1=10,C2=5,C3=3,W1=20,W2=5, W3=10,E1=10,E2=24,E3=9,I=5,L=5,R=8,S=10,T=10,P=10,B=8;
for i=0.1:0.2:1
    for j=0.1:0.2:1
        for k=0.1:0.2:1   
...
% 保存整个图形
saveas(gcf, 'C:\Users\xin\Desktop\学业\12应急物流\matlab\matlab高清图\csz_50_3.png');