...
for var = 1:3
    ...
    % 创建图例
    legend_labels = cell(length(E2_values), 1);
    for i = 1:length(E2_values)
        legend_labels{i} = ['E2=' num2str(E2_values(i))];
    end
...
% 保存图像（根据实际情况修改路径）
print(gcf, 'C:\Users\xin\Desktop\学业\12应急物流\matlab\图片\E2_xyz', '-dmeta', '-r600');